...
function imgEncryption($message, $filepath, $extention)
{

  //Edit below variables
  $msg = $message; //To encrypt
  $src = "../../chatimages/" . $filepath; //Start image
  ...
  imagepng($img, '../../chatimages/' . $filepath); //Create image
...
//Image Decryption 
function imgDecryption($filepath)
{
  $src = '../../chatimages/' . $filepath; //Change this to the image to decrypt
